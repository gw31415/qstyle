...
// app root (= scripts/ の親)。baseline cousin (baseline/scripts/build.mjs の
// copy) でも動くよう固定パスを使わない。
const fixtureRoot = path.resolve(here, '..');
// workspace root (pnpm-workspace.yaml のある dir) から qwik dist を引く。
...
const qwikDepsRoot = path.resolve(
  findWorkspaceRoot(fixtureRoot),
  'packages/qwik/node_modules/@qwik.dev',
);
