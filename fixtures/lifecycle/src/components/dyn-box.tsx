...
// object 構文の member 式で渡す (template literal 値・css 直埋め template は
// 未対応のため residual になる)。lowering は custom property 分離戦略:
...
export const DynBox = component$(() => {
  ...
  return (
    <div
      data-testid="dyn-box"
      css={{ width: width.value, backgroundColor: 'honeydew', padding: 4 }}
      onPointerMove$={(ev) => {
